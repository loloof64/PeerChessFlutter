// Taken from https://github.com/flutter-webrtc/flutter-webrtc-demo/blob/master/lib/src/utils/websocket.dart
...
class SimpleWebSocket {
  ...
  Future<WebSocket> _connectForSelfSignedCert(url) async {
    ...
    client.badCertificateCallback =
      ...
      Logger()
          .i('SimpleWebSocket: Allow self-signed certificate => $host:$port. ');
      return true;
    };
